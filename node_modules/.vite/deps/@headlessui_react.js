...
function Ae({ children: e8, enabled: t13 = true }) {
  ...
  let { refs: b11, floatingStyles: S12, context: g7 } = useFloating2({ open: i18, placement: a27 === "selection" ? p11 === "center" ? "bottom" : `bottom-${p11}` : p11 === "center" ? `${a27}` : `${a27}-${p11}`, strategy: "absolute", transform: false, middleware: [offset2({ mainAxis: a27 === "selection" ? 0 : E15, crossAxis: A6 }), shift2({ padding: c18 }), a27 !== "selection" && flip2({ padding: c18 }), a27 === "selection" && h11 ? inner({ ...h11, padding: c18, overflowRef: u24, offset: l16, minItemsVisible: D2, referenceOverflowThreshold: c18, onFallbackChange(P7) {
    var L10, N2;
    if (!P7) return;
  ...
  } }) : null, size2({ padding: c18, apply({ availableWidth: P7, availableHeight: d12, elements: M10 }) {
