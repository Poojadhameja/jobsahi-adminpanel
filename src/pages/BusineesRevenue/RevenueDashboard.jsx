...
const RevenueDashboard = () => {
  ...
  <div className="flex-1 flex flex-col">
    ...
    <div className="flex-1 p-4 sm:p-6 bg-white">
      {/* Filters */}
      <div className="mb-6 sm:mb-8 bg-[#F6FAFF] rounded-lg p-4 sm:p-6 border border-gray-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-3 bg-[#F6FAFF] p-4 sm:p-6 rounded-lg border border-gray-200">
